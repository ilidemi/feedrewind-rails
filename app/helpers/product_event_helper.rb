module ProductEventHelper
  def ProductEventHelper::log_discover_feeds(request, product_user_id, blog_url, result)
  ...
  def ProductEventHelper::log_create_subscription(request, product_user_id, subscription)
    ProductEvent::from_request!(
      request,
      product_user_id: product_user_id,
